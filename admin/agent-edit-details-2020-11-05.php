...
<?php include('../includes/admin-left-panel.php'); ?>
    ...
    <div class="right-panel column">
		...
		<input type="text" required="" placeholder="Username" value="<?php echo $record[0]['username']; ?>"
		...
		<input type="radio" value="N"
            ...
            <input type="text" placeholder="Valid From" name="subscription_date" id="subscription_date"
                   value="<?php echo $record[0]['subscription_date']; ?>" autocomplete="off" required>
          </span>
                        </li>
            ...
            <input type="text" placeholder="Valid To" name="valid_till" id="valid_till"
                   value="<?php echo $record[0]['valid_till']; ?>" autocomplete="off" required>
                        ...
                        <li><span class="half half-head">Invoice</span><span class="half no-padding"><input type="file"
                                                                                                            id="invoice"
                                                                                                            name="invoice"></span>
                        </li>
                        ...
                        <li>
                            ...
                            <span class="half no-padding">
                 <input type="text" placeholder="File Allowed (Im MB)" name="file_allowed" id="file_allowed"
                ...
                <input type="text" placeholder="Payments" name="payment" id="payment"
                       value="<?php echo $record[0]['payment']; ?>">
                        ...
                        <li>
                            ...
                            <span class="half no-padding"><textarea
                                        name="details"><?php echo $record[0]['details']; ?></textarea></span>
                        </li>
                ...
                <fieldset>
                    ...
                    <ul class="fields border">
                        <li>
                            ...
                            <span class="half no-padding">
                        <input type="text" placeholder="Facebook Url" value="<?php echo $record[0]['facebookUrl']; ?>"
                        ...
                        <li>
                            ...
                            <span class="half no-padding">
                    <input type="text" placeholder="LinkedIn Url" value="<?php echo $record[0]['linkdinUrl']; ?>"
                        ...
                        <li>
                            ...
                            <span class="half no-padding">
                    <input type="text" placeholder="Twitter Url" value="<?php echo $record[0]['twitterUrl']; ?>"
                        ...
                        <li>
                            ...
                            <span class="half no-padding">
                    <input type="text" placeholder="Google Url" value="<?php echo $record[0]['googlePlusUrl']; ?>"
                           id="googlePlusUrl" name="googlePlusUrl"></span>
                        </li>
                ...
                <fieldset>
                    ...
                    <ul class="fields border">
                        <li>
                            ...
                            <span class="half no-padding"><textarea
                                        name="remarks"><?php echo $record[0]['remarks']; ?></textarea></span>
                        </li>
                    </ul>
                </fieldset>
