...
if (isset($_POST['submit'])) {
    ...
    if (empty($agency_name)) {
        ...
        $_SESSION['error']['msg'] = '<font color="red">Please Select Crm Uses Types!</font>';
    } else if (!count($_POST['application_types'])) {

        $_SESSION['error']['msg'] = '<font color="red">Please enter Application Types!</font>';
    ...
    if (empty($_SESSION['error']['msg'])) {
        ...
        if ($development_id > 0) {
            ...
            $db->where('id', $development_id);

            $db->update('agent_developed_applications', $data);

            $_SESSION['error']['msg'] = '<font color="green">Your Development updated successfully !</font>';
            ...
            $inserted_id = $db->insert('agent_developed_applications', $data);


            if ($inserted_id > 0) {

                $_SESSION['error']['msg'] = '<font color="green">Your Development is successfully added!</font>';

                echo "<script>window.location.href='custom-development-add.php';</script>";
                exit;
            }
        }
    }
...
<div class="right-panel column">
    ...
    <form action="" method="post">
        <div class="form-container">
            ...
            <div class="form-sub-head"> Add Custom Development <a href="custom-development.php" style="font-size: 14px;"><i class="fa fa-eye"></i> View Custom Development </a> </div>
                    ...
                    <div class="rowNew">
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input name="agency_name" id="name" type="text" value="<?php echo $agency_name; ?>" class="form-control" required />
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <span class="lable"> CRM User Types <font color="red"> * </font></span>
                                ...
                                <div style="border: 1px solid #c4c8cc; padding: 4px 15px 8px 15px; -webkit-box-sizing: border-box; box-sizing: border-box; border-radius: 4px;">
                                    ...
                                    ?>
                                        <label class="checkbox">
                                            <input type="checkbox" name="application_types[]" <?php if (in_array($key, $selected_project_type)) {
                                                                                                    echo "checked";
                                                                                                } ?> value="<?php echo $key; ?>">
                    ...
                    <div class="rowNew">
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input name="web_name" id="web_name" type="text" value="<?php echo $web_name; ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input name="web_url" id="web_url" type="text" value="<?php echo $web_url; ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <span class="lable">Website Live Date</span>
                                <input class="datepicker form-control" autocomplete="off" name="web_url_live_date" id="web_url_live_date" value="<?php echo $web_url_live_date; ?>" type="text" />
                            </div>
                        </div>
                    ...
                    <div class="rowNew">
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input name="mobile_app_name_android" id="mobile_app_name_android" type="text" value="<?php echo $mobile_app_name_android; ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input class="datepicker form-control" autocomplete="off" name="android_live_date" id="android_live_date" type="text" value="<?php echo $android_live_date; ?>" />
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <span class="lable">Play Store Url</span>
                                <input name="play_store_url" id="play_store_url" type="text" value="<?php echo $play_store_url; ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div class="addContent">
                    <div class="rowNew">
                        <div class="col-2">
                            <div class="form-group">
                                <span class="lable">App Name</span>
                                <input name="mobile_app_name_ios" id="mobile_app_name_ios" type="text" value="<?php echo $mobile_app_name_ios; ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                <span class="lable">Live Date</span>
                                <input class="datepicker form-control" autocomplete="off" name="ios_live_date" id="ios_live_date" type="text" value="<?php echo $ios_live_date; ?>" />
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                                <span class="lable">App Store Url</span>
                                <input name="app_store_url" id="app_store_url" type="text" value="<?php echo $app_store_url; ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
