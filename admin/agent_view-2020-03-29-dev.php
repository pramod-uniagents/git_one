                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           ...
                           <th width="50">CRM Light  Uses</th>
                            ...
                            <th width="50">Mobile App User</th>
                        ...
                        <tr>
                            ...
                            <td  title="Mobile App User">
                                ...
                                <div class="chk_box_click" style="display:inline-block;" data-table_id="<?php echo $value['agentId']; ?>"
                                     data-field_value="<?php echo $value['mobile_app_owner']; ?>"
                                     data-field_name='mobile_app_owner'
                                >

                                    <input type="checkbox" class="js-switch" <?php if ($value['mobile_app_owner'] == 'Y') {
                                        echo 'checked="checked"';
                                    } ?>>
