...
?>	
	...
	.form-container fieldset ul.fields li{border: 1px solid #dbdbdb;border-radius: 5px;text-align:left;background:#f4f4f4;
	box-sizing:border-box;
	display:table-cell;
	float:left;
	margin:5px;color:#767676;
	}
	.form-container fieldset{min-height:60px;padding:10px; -webkit-box-shadow: 0px 0px 21px -12px rgba(0,0,0,0.5); -moz-box-shadow: 0px 0px 21px -12px rgba(0,0,0,0.5); box-shadow: 0px 0px 21px -12px rgba(0,0,0,0.5);}
