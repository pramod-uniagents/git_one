...
<form action="change_status.php" enctype="multipart/form-data" method="post">
    ...
    <div class="popup-container new-popup">
        ...
        <div class="rowNew">
            <div class="colNew">
                ...
                <?php foreach ($status_array as $key => $status_name) { ?>
                    ...
                    <label class="radiobutton">
                        <input type="radio" name="agentStatus" required value="<?php echo $key; ?>" <?php echo $agent_details['agentStatus']==$key?'checked':'';?>>
            ...
            <div class="colNew">
                ...
                foreach ($crm_uses_types_array as $key => $crm_uses_type_name) { ?>
                    ...
                    <label class="radiobutton">
                        <input type="radio" name="crm_uses_type" <?php if($agent_details['crm_uses_type']=='F'){ echo 'disabled'; }?> required value="<?php echo $key; ?>" <?php echo $agent_details['crm_uses_type']==$key?'checked':'';?>>
            ...
            <div class="colNew">
                ...
                <?php foreach ($mobile_app_users_array as $key => $mobile_app_use) { ?>
                    ...
                    <label class="radiobutton">
                        <input type="radio" name="mobile_app_owner" disabled value="<?php echo $key; ?>" <?php echo $agent_details['mobile_app_owner']==$key?'checked':'';?>>
        ...
        <div style="text-align: center; border-top: 1px solid #f1f1f1; padding-top: 15px; margin-top: 10px;">
