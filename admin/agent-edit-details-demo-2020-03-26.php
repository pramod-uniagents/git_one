	...
	if( isset($_POST['submit']) ){
		...
		*/	
			...
			if(isset($_FILES['image']['name']) AND $_FILES['image']['name']!='') {
				   ...
				   $new_name      = $random_no."_agentid_".$_SESSION[login]['id']."_date_".date("d_m_Y").".".$ext;			   
...
<div class="right-panel column">
		...
		<div id="error_msg" style="display: block; height: 40px;"><font color="red"><?php echo $_SESSION[error]['msg']; ?> </font></div>
        ...
        <li><span class="half half-head">Designation</span><span class="half no-padding"><input type="text"  placeholder="Designation" value="<?php echo $record[0]['designation']; ?>" id="designation" name="designation"></span></li>
        <li><span class="half half-head">Email</span><span class="half no-padding"><i class="fa fa-envelope icon"></i><input type="email"  placeholder="Email of Contact Person" value="<?php echo $record[0]['contact_email']; ?>" id="contact_email" name="contact_email" style="padding:4px;"></span></li>
        ...
        <li><span class="half half-head">Mobile Number</span><span class="half no-padding"><input type="text"  placeholder="Mobile Number" value="<?php echo $record[0]['mobile']; ?>" id="mobile" name="mobile"></span></li>
        ...
        <li><span class="half half-head">Valid From</span><span class="half no-padding">
			...
			<input type="text" placeholder="Valid From" name="fromDate" id="fromDate" value="<?php echo $record[0]['fromDate']; ?>" autocomplete="off">
		...
		<input type="text" placeholder="Valid To" name="toDate" id="toDate" value="<?php echo $record[0]['toDate']; ?>" autocomplete="off">
		</span>
		</li>
		<script>
        ...
        <li><span class="half half-head">Payment Description</span><span class="half no-padding"><textarea name="details"><?php echo $record[0]['details']; ?></textarea></span></li>
		</ul>
		</fieldset>	
		<fieldset>
		<legend>Additional Information</legend>
		<ul class="fields border">
        <li><span class="half half-head">Facebook Url</span><span class="half no-padding"><input type="text" placeholder="Facebook Url" value="<?php echo $record[0]['facebookUrl']; ?>" id="facebookUrl" name="facebookUrl"></span></li>
        <li><span class="half half-head">LinkedIn Url</span><span class="half no-padding"><input type="text" placeholder="LinkedIn Url" value="<?php echo $record[0]['linkdinUrl']; ?>" id="linkdinUrl" name="linkdinUrl"></span></li>
        <li><span class="half half-head">Twitter Url</span><span class="half no-padding"><input type="text" placeholder="Twitter Url" value="<?php echo $record[0]['twitterUrl']; ?>" id="twitterUrl" name="twitterUrl"></span></li>
        <li><span class="half half-head">Google Url</span><span class="half no-padding"><input type="text" placeholder="Google Url" value="<?php echo $record[0]['googlePlusUrl']; ?>" id="googlePlusUrl" name="googlePlusUrl"></span></li>
		...
		<ul class="fields border">
         <li><span class="half half-head">Marketing Remarks</span><span class="half no-padding"><textarea name="remarks"><?php echo $record[0]['remarks']; ?></textarea></span></li>
        </ul>
